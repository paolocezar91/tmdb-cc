...
export default function MovieDetails({ movie }: { movie: Record<string, string | number> }) {
  return <div className="flex flex-col md:flex-row gap-4 overflow-auto max-h-[90vh]">
    ...
    <div className="title flex flex-col">
      <h2 className="bold text-xl border-b-2 border-solid mb-2" title={String(movie.title)}>Movie Title: {movie.title}</h2>
